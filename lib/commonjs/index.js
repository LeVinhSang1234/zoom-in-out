...
var ScrollInverted = /** @class */ (function (_super) {
    ...
    ScrollInverted.prototype.render = function () {
        ...
        return (jsxRuntime.jsx("div", __assign({ className: clsx("scroll-inverted-wrap", classNameWrap), style: styleWrap }, { children: jsxRuntime.jsx("div", __assign({ className: clsx("scroll-inverted-container", className), ref: function (ref) { return (_this.divScroll = ref); }, style: style, onScroll: this.onScrollMobile }, { children: jsxRuntime.jsx("div", __assign({ style: __assign(__assign({}, styleContentContainer), { position: "relative" }), className: clsx("scroll-inverted-content", classNameContentContainer), ref: function (ref) { return (_this.divContentWrap = ref); } }, { children: jsxRuntime.jsx("div", __assign({ ref: function (ref) { return (_this.divContent = ref); } }, { children: dataRender.map(function (item, index) { return (jsxRuntime.jsx(ItemRenderring, __assign({ id: "item-render-".concat(dataRender.length - index) }, { children: renderItem === null || renderItem === void 0 ? void 0 : renderItem({ item: item, index: index }) }), (keyExtractor === null || keyExtractor === void 0 ? void 0 : keyExtractor(item, index)) || index)); }) })) })) })) })));
    };
